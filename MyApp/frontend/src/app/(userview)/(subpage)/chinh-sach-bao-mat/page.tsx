export default function PrivatePolicyPage() {
  return (
    <>
      <h2>
        <p>
          Privacy Policy of <span id="domain">My Shop</span>
        </p>
      </h2>
      ...
      <p>
        ...
        technical service providers, mail carriers, hosting providers, IT companies, communications agencies) appointed,
        if necessary, as Data Processors by the Owner. The updated list of these parties may be requested from the Owner
        at any time.
      </p>
      <p>
        <br />
      ...
      <p>
        ...
        the section containing details about the processing of Personal Data.
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        ...
        parties), detect any malicious or fraudulent activity, as well as the following: Analytics.
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        Receive their Data and have it transferred to another controller. Users have the right to receive their Data in
        a structured, commonly used and machine readable format and, if technically feasible, to have it transmitted to
        another controller without any hindrance. This provision is applicable provided that the Data is processed by
        automated means and that the processing is based on the User&apos;s consent, on a contract which the User is
      ...
      <p>
        ...
        object to that processing at any time without providing any justification. To learn, whether the Owner is
      ...
      <p>
        ...
        to Users via any contact information available to the Owner. It is strongly recommended to check this page
      ...
      <h2 style={{ color: "rgb(192, 40, 40)" }}>Instructions for deleting user data.</h2>
      <p style={{ color: "rgb(192, 40, 40)" }}>Any request to delete information please email to: support@myshop.com</p>
    </>
  );
}
